...
object SenderMoney {
    ...
    public fun startSending(scoreFrom: String, scoreTo: String, takerName: String, howMuch: String) {
        println("###################### startSending has been launched ##############################")
        val okHttpClient = OkHttpClient()
        val payload = "{\"ScoreFrom\":\"$scoreFrom\", \"ScoreTo\":\"$scoreTo\", \"TakerName\":\"$takerName\", \"HowMuch\":$howMuch}"
        println(payload)
